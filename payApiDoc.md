...
商户订单号 | mchOrderNo | 是 | String(30) | 20160427210604000490 | 商户订单号,不能超过26位
...
支付成功时间 | paySuccTime | 否 | String | 2026-09-09 18:43:36 | 支付成功时间，精确到毫秒
签名 | sign | 是 | String(32) | C380BEC2BFD727A4B6845133519F3AD6 | 签名值，详见签名算法
...
```json
{
    ...
    "msg": "操作成功",
    "data": {
      "payOrderId": "AGG2026090918432500282153543",
      "merchantId": "M1212",
      "channelId": "8013",
      "mchOrderNo": "2026090918432561663",
      "amount": 500,
      "income": 500,
      "status": 2,
